...
def serve_static(path):
    root_dir = os.getcwd()
    return flask.send_from_directory('../C39-T3_CRUSHER_HOPPER_2025-01-10_15_07_25_696.mp4', path)
...
def build_video_feed():
    return html.Div(
        ...
        children=[
            dp.DashPlayer(
                id='video-player',
                url='/static/C39-T3_CRUSHER_HOPPER_2025-01-10_15_07_25_696.mp4',  # Replace with your live stream URL
                controls=True,
                playing=True,
                width='100%',
                height='400px'
